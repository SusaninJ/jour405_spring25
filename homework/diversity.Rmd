...
It is tough to tell from looking at the raw numbers, but one city that stands out is Baltimore City. This is probably just based off the number of people in the city, but it also shows high numbers in a lot of the different categories. More cities around Baltimore (Dundalk and Towson) also pop out with their figures.
...
Summerfield had the highest race probability. This makes sense because when looking at the raw numbers, they have significantly more Black people than other races. Therefore, the probability that two black people will be chosen from there is very high.
...
What I first noticed about the Hispanic probability is that the lowest numbers (around 50) were significantly higher than the race percentage numbers (some as low as 4). The lowest one is Chillum. The first sentence makes sense when looking at these numbers because the difference in total between Hispanic and non-Hispanic was not that large compared to the difference between races. Also the fact that there are only two categories helps this.
...
The top three were Langley Park, Wheaton, and Adelphi. All of them are in the DC area with Langley Park and Adelphi in PG County and Adelphi in Montgomery County. Lake Shore had the lowest percentage. Located in Anne Arundel County, it has mostly white and non-hispanic people.
...
DC Area Cities Lead Diversity Index in Maryland

Langley Park and Adelphi in Prince George's County, and Wheaton in Montgomery County, were the top three most diverse cities in USA Today Diversity Index for last year. Langley Park had a diversity index of over 97, while Wheaton and Adelphi had numbers over 90. These numbers represent how likely it is that two people chosen randomly from the city would not be the same race or ethnicity.

For interviews for this story, I would talk to the mayor or city council members from the city about the diversity in the city and if there are any programs that encourage diversity. I would also do person on street interviews to see what residents think about the diversity in the city.
