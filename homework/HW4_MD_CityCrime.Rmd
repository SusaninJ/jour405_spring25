...
ANSWER HERE Overall, both property crime and violent crime rates went down in most Maryland cities. The only cities where there was a significant jump up were smaller cities that went up by one or two instances.
...
ANSWER HERE I was surprised to find out that there were a couple cities were violent rates went down and property rates went up and vice versa. Intuition would tell you that there would be some sort of correlation but I guess that's wrong.
...
ANSWER HERE The rates of both violent and property crime went down in Baltimore in 2020 compared to 2019.

The violent crime rate went down 12 percent, while property crime dropped over 25 percent. These crime rates were down to 15 incidents per 1000 people for violent crime and 31 incidents per 1000 people for property crime.
