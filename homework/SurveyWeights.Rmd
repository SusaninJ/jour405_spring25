...
If they do it by phone, it is more likely that a more highly educated population would have access to the phone compared to a lower educated group.
...
College Graduates Vote More Than People At Other Education Levels
...
The group that saw the biggest change was the high school or less group with their number going down by about three percent.

2. Why might the weighted results be considered more accurate than the unweighted results?

Given the weights we apply, we can find out the meaning of these group's numbers a bit more.
...
It again is the high school group. We can see their yes number going down and their no and sure numbers going up.
...
In both weighted and unweighted studies, college graduates said they would vote more than people who did not graduate college. Both people who spent some time in college and those who did not had lower numbers than the college graduates.
However, the weighting showed more effective results. Given the weights that were placed on each response, we were able to gather more correct and important numbers to report in our story.
...
It is important to understand how much every response matters. This makes what we are reporting on easier and better to do.
2. How might the differences between weighted and unweighted results affect how you would report on this data?
I would just know more of the story using the weighted results.
...
I would want to know exactly where the data came from, like who the people are and where they are in the world before looking fully at the weights.
