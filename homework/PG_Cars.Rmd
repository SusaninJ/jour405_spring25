...
It is obvious that the spike year was a big leaping point for car thefts in PG County. While there weren't as many thefts (and the rate wasn't as high) in the years after the spike, they still were up from numbers before the spike.
...
Car Theft Rates Spike in 2023, Continue To Be High in 2024
...
- **Null Hypothesis (H0)**: The Car Theft Rates grew significantly after the spike year

- **Alternative Hypothesis (H1)**: The Car Theft Rates did not grow after the spike year
...
Since the F-Value (218) is large, it means the null hypothesis is confirmed. The results are significant due to the reults of the ANOVA test and there is a significant difference between the average rates of every year.
...
The chart shows a difference of at least 16 between every single category. Therefore, there is a significant difference between all 3. The pre-spike and post-spike difference of just over 20 is very big meaning that that is the middle difference of the three.
