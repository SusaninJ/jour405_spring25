...
Most of the data appears to be from 7-15. There are some outliers on the higher and lower sides. For example, there is a day in early October that appears to go above 25. I would draw a horizontal line for anything above 20 and anything below 4.
...
It looks like my estimation for 20 was a bit high as the red dots for unusually high occur mostly around 18 and up. For my lower estimate, it looks like I'm not that far off, as the blue dots for unusually low occur around the 3-4 range.
...
October Fourth was the most unique day, given that the number of calls on that particular Tuesday was higher than the average Tuesday. It was higher than any other day compared to the average.
...
I think an angle to take for reporting about this would be why numbers were so low in the winter months compared to the summer months. While this doesn't necessarily relate to z-scores, I think this would be an interesting thing to report on. I would look to see if there were any outlier dates with high z scores in those months and see if anything happened on those dates. As far as next steps, I would talk to different officials who are experts on this stuff to see if they have a reason for why this cold be.
