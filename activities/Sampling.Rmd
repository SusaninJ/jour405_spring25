...
```{r}
set.seed(42) # Setting seed for repoducibility
population <- tibble(
...
After looking at the means of the samples, the sample with the largest number of people has the closest mean and standard deviation. However, given that the sample was only 10 percent, it gives me belief that it is possible to do samples with not a large amount of people.
