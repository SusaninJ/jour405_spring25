...
There is a slight positive relationship as the line of best fit slightly slants upwards. However, I would be hesitant to call it a positive relationship in the story as there is not the dots are all over the place.
...
The valuable model states the p-value, which shows that the relationship between the FARMS number and math scores are not very strong because the number is insignificant.
...
The largest differences are the absolute residuals, with Whitemarsh Elementary School having a residual of just under 35.Gulph, Crooked Billet and Lower Gwynned Elementary Schools all had scores above 30, meaning their differences are very high.
...
This is incorrect and can not be stated on fact after looking at the data from are tests. Many schools had a big residual, meaning that their numbers far apart from what the board member would've expected if this was true. A story would largely include the data and say that there is no direct relationship between these two.
