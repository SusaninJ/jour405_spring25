...
The minimum weight is 0.2298 and the maximum is 3.0386
2. What does it mean when a respondent has a weight of 0.23? What about 3.04?
The people with less weight will not have their response counted as much while the people with more will have more of a say in the final results.
3. Why might some respondents be weighted more heavily than others?
People have more say if their responses are similar to other people's responses.
...
The rarely voted category had the biggest difference.
2. How might these differences affect reporting on likely voter turnout?
If the people who rarely vote come out in this election, their influence will be stronger for this election given their rare turnout.
...
If something happens for rare voters between the time they were polled and election night, that means something could easily flop in their mind. For example if one candidate says something one way or the other regarding a certain issue that a rare voter cares about deeply, that might influence their decision on if they should vote and who they should vote for.
