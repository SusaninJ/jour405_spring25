...
Each number is different. Some are bigger some are smaller. For example, the observed frequencies of 5 stars and 3 stars are lower than the expected, while 1, 2, and 4 stars all have bigger observed frequencies.
...
We reject the null hypothesis due to the critical value being lower than the chi-square number. This goes along with what we noticed earlier, that the observed frequencies are different than the expected frequencies. 
