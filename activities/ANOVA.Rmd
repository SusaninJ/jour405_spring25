...
All of these scores concur with my prior beliefs about SAT scores. Private schools have the highest mean and the least variance as far as standard deviation. It makes sense that community college has the highest standard deviation because a lot of community college students are forced to go that route due to monetary reasons instead of academic reasons and vice versa. The public school numbers are in between community and private which makes sense.
...
After looking at the numbers and running the test, there is a significant difference in SAT scores between Communnity College, Private colleges, and public colleges. The biggest difference is between community college and private schools, with a difference of 366 according to the second test.

Private Colleges have Higher SAT Scores than Other Schools.
