...
The only significant part of this model was it told us that if you score a lot of points you are a etter team which is realtively obvious. However, every other number is not very significant, meaning that the model as a whole is not particularly useful.
...
Points scored has the most impact on wins, given the coefficiant with wins being the highest at 0.708. The least impactful is yards gained with a coefficiant below 0.5.
...
You could use this by looking at the coefficiants and how they relate to winning. If I were a beat reporter for a team, I would like at other statistics besides what we have here, potentially looking at different ways of gaining yards and/or preventing yards.
